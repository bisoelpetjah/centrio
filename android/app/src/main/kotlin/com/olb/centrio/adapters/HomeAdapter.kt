package com.olb.centrio.adapters
...
import com.olb.centrio.utils.DimensionHelper
import com.olb.centrio.views.HomeProfileView
import com.olb.centrio.views.TransactionItemView
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): HomeItemViewHolder {
        when (viewType) {
            ...
            TYPE_TRANSACTION -> {
                ...
                view.minimumHeight = DimensionHelper.dpToPx(parent.context, 240F).toInt()
